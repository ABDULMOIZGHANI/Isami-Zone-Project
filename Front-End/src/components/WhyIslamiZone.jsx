...
const WhyIslamiZone = () => {
  return (
    <section>
      ...
      <div className="w-[85%] m-auto bg-[#246545] flex justify-evenly gap-[20px] p-[30px] pt-[50px] pb-[50px] rounded-[12px] mb-20 shadow-[8px_8px_12px_rgba(0,0,0,0.25)]">
        {ChooseIslamiZone.map((value) => (
          <div className="text-center flex flex-col gap-5 w-[33%]">
